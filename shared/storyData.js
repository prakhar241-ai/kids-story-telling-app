...
export const TEMPLATES = [
  ...
  },
  {
    ...
    en: (s) => ({
      ...
      body: `${s.opener} ${s.hero} ${s.trait} and played all day in the ${s.place}. Oh my — those little hands got dusty!\n\nBefore eating, ${s.hero} washed them with soap and water. Scrub, scrub, splash! Now they were clean, and ${s.hero} ate a happy meal.`,
      moral: `Clean hands keep us healthy.`,
    }),
    hi: (s) => ({
      title: `${s.heroHi} ने हाथ धोए`,
      body: `${s.openerHi} ${s.heroHi} ${s.traitHi} और दिन भर ${s.placeHi} में खेला। अरे — नन्हे हाथ धूल से सने हो गए!\n\nखाने से पहले ${s.heroHi} ने साबुन और पानी से हाथ धोए। रगड़ो, रगड़ो, छप-छप! अब हाथ साफ़ हो गए, और ${s.heroHi} ने खुशी से खाना खाया।`,
  ...
  },
  {
    ...
    hi: (s) => ({
      ...
      body: `${s.openerHi} ${s.heroHi} ${s.traitHi}। पर अरे — ${s.placeHi} में खिलौने हर जगह बिखरे थे!\n\nतो ${s.heroHi} ने सफ़ाई का गाना गाया और हर खिलौना डिब्बे में रखा। एक, दो, तीन — हो गया! ${s.placeHi} साफ़ हो गया, और ${s.heroHi} खुशी से ताली बजाने लगा।`,
  ...
  // ════════ AGE 7-9 : 3-4 short paragraphs ════════
  {
    ...
    hi: (s) => ({
      ...
      body: `${s.openerHi} ${s.heroHi} ${s.traitHi}। ${s.placeHi} में हर कोई हर साल होने वाले उछल-कूद खेल की तैयारी कर रहा था, जो प्यारी पहाड़ी तक होता था। ${s.heroHi} सबसे तेज़ नहीं था, पर कोशिश करना उसे बहुत पसंद था!\n\nजब कुछ दोस्त आराम करते, ${s.heroHi} हर सुबह चुपचाप अभ्यास करता। उछल, कूद, डगमग, धम — और फिर हँसते हुए ऊपर। कुछ सुबहें मुश्किल होतीं, पर ${s.heroHi} हमेशा एक बार और कोशिश करता।\n\nखेल के दिन बाकी आधी पहाड़ी पर ही थक गए। धीरे और लगातार, ${s.heroHi} खुशी से कदम बढ़ाता रहा और एक प्यारी छलाँग के साथ चोटी पर पहुँचा।\n\nसबने तालियाँ बजाईं। "मैं सबसे तेज़ नहीं हूँ," ${s.heroHi} ने मुस्कुरा कर कहा, "पर मैंने कोशिश करना कभी नहीं छोड़ा!"`,
  ...
  },
  {
    ...
    hi: (s) => ({
      ...
      body: `${s.openerHi} ${s.heroHi} ${s.traitHi}। ${s.heroHi} बहुत होशियार था और ${s.placeHi} की लगभग हर पहेली सुलझा लेता था। जल्दी ही ${s.heroHi} कहने लगा, "मुझे हमेशा सबसे अच्छा पता है!" और छोटे दोस्तों की सुनना बंद कर दिया।\n\nएक दिन एक बड़ा पहेली-बक्सा आया, जिस पर एक पेचीदा ताला था। ${s.heroHi} ने इधर-उधर बहुत कोशिश की, पर वह खुला ही नहीं। हुंह!\n\nएक शांत नन्हा घोंघा, जिसकी ${s.heroHi} नहीं सुन रहा था, धीरे से बोला, "इसे दूसरी ओर घुमा कर देखो।" ${s.heroHi} ने ऐसा किया — और खट! — बक्सा खुल गया, मज़ेदार खिलौनों से भरा।\n\n${s.heroHi} थोड़ा शरमाया। "माफ़ करना, मैंने नहीं सुना। हर किसी के पास अच्छे विचार होते हैं!" इसके बाद ${s.heroHi} छोटे-बड़े सब दोस्तों की सुनने लगा।`,
  ...
  },
  {
    ...
    hi: (s) => ({
      ...
      body: `${s.openerHi} ${s.heroHi} ${s.traitHi} और ${s.placeHi} में चारों ओर देखा। वह थोड़ा गंदा हो गया था — इधर-उधर कागज़ पड़े थे, और नन्ही धारा मैली लग रही थी।\n\nकुछ दोस्तों ने कंधे उचका कर कहा, "यह हमारा काम नहीं।" पर ${s.heroHi} अपने घर से बहुत प्यार करता था। हर दिन ${s.heroHi} थोड़ा कचरा उठाता और एक नन्हा पौधा लगाता।\n\nयह देख कर एक दोस्त जुड़ा, फिर दूसरा, फिर पूरी खुशमिज़ाज टोली। सब कचरा कूड़ेदान में डालते और कतार में पौधे लगाते, गाते-गाते।\n\nएक मौसम में ${s.placeHi} फिर हरा-भरा हो गया, चमकते पानी और चहचहाते पक्षियों के साथ। "जब हम अपने घर का ख्याल रखते हैं," ${s.heroHi} मुस्कुराया, "तो घर हम पर मुस्कुराता है।"`,
